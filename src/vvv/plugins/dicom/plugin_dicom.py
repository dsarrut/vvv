...
from .ui_dicom_plugin import DicomPluginUI
from .control_dicom import DicomPluginController


class DicomPlugin(PluginProtocol):
    plugin_id = "dicom_plugin"
    label = "DICOM Browser"
    ...
    def __init__(self):
        ...
        self._ui = DicomPluginUI(self.plugin_id, self._controller)
