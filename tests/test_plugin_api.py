...
class TestPluginAPI(unittest.TestCase):
    ...
    def test_discover_plugins_success(self):
        ...
        self.assertEqual(plugin_ids, ["intensity_plugin", "profile_plugin", "landmark_plugin", "threshold_plugin", "dicom_plugin", "registration_plugin", "roi_plugin", "mip_plugin", "memory_plugin", "dvf"])
